...
def plot_health_problems(chart_frame):
    ...
    # Establecer color blanco para los textos
    plt.setp(texts, color='white')
    plt.setp(autotexts, color='white')
    
    # Añadir título y leyenda con color blanco
    ax1.set_title('Distribución de Problemas de Salud', color='white')
    ...
    ax2.set_title('Cantidad de Casos por Problema', color='white')
    ax2.set_ylabel('Número de Casos', color='white')
    
    # Establecer color blanco para los ticks
